...
def display(preds, imgs, image_info, imshow=True, imwrite=False):
    ...
    for obj in preds:
        ...
        plot_one_box(imgs, [x1, y1, x1+x2, y1+y2], label=label,
...
if __name__ == '__main__':
    ...
    VIS_PATH = 'datasets/argoverse/temp_bbox'
    #BBOX_PATH = 'sid_17_3_bbox_results.json'
    BBOX_PATH = 'results/sid17_bbox_d0.json'
    ...
    for image_id in image_ids:
        ...
        anns = []
        for obj in data:
            if obj["image_id"] == image_id and obj["category_id"] == 1:
                anns.append(obj)
